...
<div class="main-agile">
    ...
    <div class="agile-top">
        ...
        <div class="col-xs-2 menu">
            ...
            <nav>
                <a href="Updates.php">Home</a>
                <a href="#updates" class="scroll">Updates on Recent Movies</a>
        ...
        <ul class="rslides callbacks callbacks1" id="slider4">
                ...
                <div class="w3layouts-banner-top banner">
                    <div class="container">
                        <div class="agileits-banner-info">
                            <h3><span style="color:Red">Updates On Recent Movies</span></h3>
            ...
            <li>
                <div class="w3layouts-banner-top banner-2">
                    <div class="container">
                        <div class="agileits-banner-info">
                            <h3><span style="color:yellow">Updates on Cast, Crew, Directors and more</span></h3>
            ...
            <li>
                <div class="w3layouts-banner-top banner-3">
                    <div class="container">
                        <div class="agileits-banner-info">
                            <h3><span style="color:Red">Updates on release dates and more</span></h3>
                            <p><span style="color:yellow"><b>Cinema</b></span>
                                <i class="fa fa-film" aria-hidden="true"></i><span style="color:yellow"> <b>is a matter of what's in the frame and what's out</b></span></p>
                            <div class="video-pop-wthree">
...
<div class="contact" id="updates">
    <div class="title-div">
        <h3 class="tittle">
            <span style="color:Red">U</span>pdates<span style="color:Red">  O</span>n <span style="color:Red">  R</span>ecent <span style="color:Red">  M</span>ovies
        </h3>
  ...
  <ol>
    <span style="color:red">
      <p>
          ...
          <li> Movie name:-</li>
          <ul>
         <li><b>Star Wars: Episode III - Revenge of the Sith</b></li>

           </ul>

    <li><span style="color:GREEN">Movie Director:- </span></li>
    <ul>
    <li>George Lucas</li>
    ...
    <li> Movie Cast  :- </li>
    <ul>
    <li> Hayden Christensen, Natalie Portman, Ewan McGregor </li>

    </ul>

    <li> Movie name:-</li>
          <ul>
         <li><b>Avengers: Infinity War</b></li>

           </ul>

    <li><span style="color:GREEN">Movie Director:- </span></li>
    <ul>
    <li>Anthony Russo, Russo brothers</li>

    </ul>

    <li> Movie Cast  :- </li>
    <ul>
    <li>1. Robert Downey, Jr. as Tony Stark/Iron Man 2. Chris Hemsworth as Thor 3. Mark Ruffalo as Bruce Banner/Hulk 4. Chris Evans as Steve Rogers/Captain America 5. Scarlett Johansson as Natasha Romanoff/Black Widow 6. Don Cheadle as James Rhodes/War Machine 7. Benedict Cumberbatch as Stephen Strange/Doctor Strange 8. Tom Holland as Peter Parker/Spider-Man 9. Chadwick Boseman as T'Challa/Black Panther 10. Zoe Saldana as Gamora</li>

    </ul>

    <li> Movie name:-</li>
          <ul>
         <li><b>Batman v Superman: Dawn of Justice</b></li>
    ...
    <li> Movie Cast  :- </li>
    <ul>
    <li>1. Ben Affleck as Bruce Wayne/Batman 1. Brandon Spink as young Bruce Wayne 2. Henry Cavill as Kal-El/Clark Kent/Superman 3. Amy Adams as Lois Lane 4. Jesse Eisenberg as Lex Luthor 5. Diane Lane as Martha Kent 6. Laurence Fishburne as Perry White 7. Jeremy Irons as Alfred Pennyworth 8. Holly Hunter as Senator June Finch 9. Gal Gadot as Diana Prince/Wonder Woman 10. Scoot McNairy as Wallace Keefe 11. Callan Mulvey as Anatoli Knyazev 12. Tao Okamoto as Mercy Graves </li>
