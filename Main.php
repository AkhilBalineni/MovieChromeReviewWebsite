            ...
            <ul>
                <li>
                    <a href="#" data-toggle="modal" data-target="#myModal1">
                        <span class="fa fa-unlock-alt" aria-hidden="true" style="color:Red"></span> Sign In </a>
                </li>
                <li>
                    <a href="#" data-toggle="modal" data-target="#myModal2">
                        <span class="fa fa-pencil-square-o" aria-hidden="true" style="color:Red"></span> Sign Up </a>
                </li>
            </ul>
        </div>
        <!-- navigation -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body modal-body-sub_agile">
                ...
                <div class="modal_body_left modal_body_left1">
                    <h3 class="agileinfo_sign"><span style="color:Red"><b>Sign In</b></span> </h3>
                    <p>
                        Sign In now, Start Giving Reviews to Movies. Don't have an account?
                        <a href="#" data-toggle="modal" data-target="#myModal2">
                            Sign Up Now</a>
                    </p>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body modal-body-sub_agile">
                ...
                <div class="modal_body_left modal_body_left1">
                    <h3 class="agileinfo_sign"><span style="color:Red"><b>Sign Up</b></span></h3>
                    <p>
                        Come join the Us! Let's set up your Account.
                    </p>
                    <form action="signup.php" method="post">
                      <div class="styled-input">
                          <input type="text" placeholder="Email" name="email" id="CreateUsername" required>
                      </div>
                        <div class="styled-input">
                            <input type="text" placeholder="Username" name="username" id="CreateUsername" required>
                        </div>
                        <div class="styled-input">
                            <input type="password" placeholder="Password" name="password" id="password1" required >
                        </div>
                        <div class="styled-input">
                            <input type="password" placeholder="ConfirmPassword" name="password" id="password2" required>
                        </div>
                        <input type="submit" value="Sign Up" onsubmit="validatePassword()">
                    </form>
                    <p>
                        <a href="T&C.php" target=_blank>By clicking register, I agree to your terms</a>
                    </p>
                </div>
            </div>
        </div>
